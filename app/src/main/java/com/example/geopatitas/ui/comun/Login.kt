...
import com.example.geopatitas.viewmodel.LoginUiState
import com.example.geopatitas.viewmodel.LoginViewModel
        ...
        when (uiState) {
            ...
            is LoginUiState.AuthenticatedAndRegistered -> {
                ...
                when (user.tipoUsuario) {
                    "Ciudadano" -> navController.navigate(AppDestinations.VecinoFlow.DASHBOARD) {
                        popUpTo("login_route") { inclusive = true } // Limpia el back stack
                    }

                    "Organizacion" -> navController.navigate("organizacion_dashboard") {
