...
import com.example.geopatitas.ui.screen.vecino.ReporteFormScreen
import com.example.geopatitas.ui.screen.vecino.VecinoPerfilScreen
    ...
    ModalNavigationDrawer(
        ...
        drawerContent = {
            ModalDrawerSheet {
                ...
                NavigationDrawerItem(
                    label = { Text("Perfil") },
                    selected = selectedRoute == "aliado_perfil",
                    onClick = {
                        selectedRoute = "aliado_perfil"
                        coroutineScope.launch { drawerState.close() }
                        localNavController.navigate("aliado_perfil") { launchSingleTop = true }
                    },
                    icon = { Icon(Icons.Default.Person, contentDescription = "Perfil") }
                )
                NavigationDrawerItem(
                    label = { Text("Mis reportes") },
                    selected = selectedRoute == "aliado_reportes",
                    onClick = {
                        selectedRoute = "aliado_reportes"
                        coroutineScope.launch { drawerState.close() }
                        localNavController.navigate("aliado_reportes") { launchSingleTop = true }
                    },
            ...
            Box(modifier = Modifier.padding(innerPadding)) {
                NavHost(
                    ...
                    composable("aliado_perfil") {
                        AliadoPerfilScreen(userViewModel = userViewModel)
                    }
                    ...
                    composable("reportes") {
                        ReportesScreen(
                            ...
                            onReporteClick = { reporteId ->
                                localNavController.navigate("detalle_reporte/$reporteId?editable=atendible")
                            }
                        )
                    }

                    composable(
                        route = "atender_reporte/{reporteId}",
                        arguments = listOf(
